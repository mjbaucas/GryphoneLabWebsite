    ...
    render() {
        return (
            <Grid>
                <Col>
                    <h1>Who We Are</h1>
                    <p>The GryPhone Lab is an open-access smartphone testbed at the University of Guelph. 
                    ...
                    Building 301B, and on Facebook.</p>
                </Col>
                <Col> 
                    <h1>What We Do</h1>
                    <p>The GryPhone Lab is a smartphone testbed designed to neable mobile systems research 
                    ...
                    Feel free to contact us if you have a great new idea for Android platform features.</p>
                </Col>
                <Col>
                    <h1>Our Sponsors</h1>
                    <p>We gratefully thank our sponsors for their support.</p>
                </Col>
            </Grid>
        )
    }
